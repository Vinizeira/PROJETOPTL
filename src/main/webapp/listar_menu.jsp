...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <a href="form_menu.jsp" class="btn btn-primary" id="novo">Novo Menu</a>
            <table class="table table-hover table-striped table-bordered display" id="listarMenu">
                ...
                <jsp:useBean class="model.MenuDAO" id="mDAO"/> <!-- Criando um perfil com jstl-->
                <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="gerenciar_menu.do?acao=alterar&idMenu=${m.idMenu}">  <!-- ELEMNTOS DO BOOTSTRAP-->
